...
export const ACTIVITY_DEFINITIONS = [
  ...
  },
  {
    ...
    rowTypes: [
      ...
      {
        key: "summary",
        label: "บันทึกแบบสรุปการทบทวนการส่งต่อ/ปฏิเสธการรักษา",
        fields: [
          ...
          { name: "importantCaseEventDate", label: "กรณีสำคัญมาวิเคราะห์: วันเดือนปีที่เกิดเหตุการณ์", type: "date" },
          { name: "importantCaseReviewDate", label: "กรณีสำคัญมาวิเคราะห์: วันเดือนปีที่ทบทวน", type: "date" },
          {
            name: "importantCaseTransferType",
            label: "กรณีสำคัญมาวิเคราะห์: ประเภท",
            type: "select",
            options: ["ส่งต่อ", "ขอย้าย", "ปฏิเสธการรักษา"],
          },
          { name: "importantCaseTransferCause", label: "กรณีสำคัญมาวิเคราะห์: สาเหตุ", type: "textarea" },
          { name: "importantCaseSummary", label: "กรณีสำคัญมาวิเคราะห์: สรุปเหตุการณ์", type: "textarea" },
          { name: "importantCaseCareOutcome", label: "กรณีสำคัญมาวิเคราะห์: ผลลัพธ์การดูแลผู้ป่วย", type: "textarea" },
          { name: "importantCaseAction", label: "กรณีสำคัญมาวิเคราะห์: การดำเนินการแก้ไข", type: "textarea" },
          { name: "importantCaseRecommendation", label: "กรณีสำคัญมาวิเคราะห์: ข้อเสนอแนะเพื่อปรับปรุง", type: "textarea" },
        ],
      },
    ],
  },
